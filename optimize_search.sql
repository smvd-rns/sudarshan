...
-- This optimization works by FIRST fetching the matched rows using indexes, 
-- and ONLY THEN calculating word_similarity on the small matched subset (instead of all 2.6 Lakh rows).
